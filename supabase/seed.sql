...
join (values
  ('Launch prep', 'Agency agreement signed', 0),
  ('Launch prep', 'AML checks complete', 1),
  ('Launch prep', 'Accounts received (3 years)', 2),
  ('Launch prep', 'Marketing details approved by seller', 3),
  ('Launch prep', 'Photography done', 4),

...
export const LAUNCH_PRACTICE_FIELDS =
  "id, ref, display_title, name, address_line1, town, county, postcode, confidential, status, asking_price, price_prefix, surgeries, udas, staff_count, annual_turnover, ebitda, reconstituted_profit, nhs_contract_value, established_year, funding_type_id, tenure_type_id, trading_entity_id, specialism_ids, description";
